...
document.getElementById("btn-daily").addEventListener("click", async function () {
    ...
    document.getElementById("play-previous").textContent = data[1].timeframes.daily.previous === 1 ? "Yesterday - " + data[1].timeframes.daily.previous + "h" : "Yesterday - " + data[1].timeframes.daily.previous + "hrs";
...
document.getElementById("btn-monthly").addEventListener("click", async function () {
    ...
    document.getElementById("work-current").textContent = data[0].timeframes.monthly.current === 1 ? data[0].timeframes.monthly.current + "hr" : data[0].timeframes.monthly.current + "hrs";
    document.getElementById("work-previous").textContent = data[0].timeframes.monthly.previous === 1 ? "Last Month - " + data[0].timeframes.monthly.previous + "hr" : "Last Month - " + data[0].timeframes.monthly.previous + "hrs";

    document.getElementById("play-current").textContent = data[1].timeframes.monthly.current === 1 ? data[1].timeframes.monthly.current + "hr" : data[1].timeframes.monthly.current + "hrs";
    document.getElementById("play-previous").textContent = data[1].timeframes.monthly.previous === 1 ? "Last Month - " + data[1].timeframes.monthly.previous + "hr" : "Last Month - " + data[1].timeframes.monthly.previous + "hrs";

    document.getElementById("study-current").textContent = data[2].timeframes.monthly.current === 1 ? data[2].timeframes.monthly.current + "hr" : data[2].timeframes.monthly.current + "hrs";
    document.getElementById("study-previous").textContent = data[2].timeframes.daily.previous === 1 ? "Last Month - " + data[2].timeframes.monthly.previous + "hr" : "Last Month - " + data[2].timeframes.monthly.previous + "hrs";

    document.getElementById("exercise-current").textContent = data[3].timeframes.monthly.current === 1 ? data[3].timeframes.monthly.current + "hr" : data[3].timeframes.monthly.current + "hrs";
    document.getElementById("exercise-previous").textContent = data[3].timeframes.monthly.previous === 1 ? "Last Month - " + data[3].timeframes.monthly.previous + "hr" : "Last Month - " + data[3].timeframes.monthly.previous + "hrs";

    document.getElementById("social-current").textContent = data[4].timeframes.monthly.current === 1 ? data[4].timeframes.monthly.current + "hr" : data[4].timeframes.monthly.current + "hrs";
    document.getElementById("social-previous").textContent = data[4].timeframes.monthly.previous === 1 ? "Last Month - " + data[4].timeframes.monthly.previous + "hr" : "Last Month - " + data[4].timeframes.monthly.previous + "hrs";

    document.getElementById("self-care-current").textContent = data[5].timeframes.monthly.current === 1 ? data[5].timeframes.monthly.current + "hr" : data[5].timeframes.monthly.current + "hrs";
    document.getElementById("self-care-previous").textContent = data[5].timeframes.weekly.previous === 1 ? "Last Month - " + data[5].timeframes.monthly.previous + "hr" : "Last Month - " + data[5].timeframes.monthly.previous + "hrs";
});